...
**وضعیت:** هر ۲۱ گام نقشه‌ی راه پیاده‌سازی و تست شد؛ اصلاحات بازبینی (Review) هم اعمال شد. 12 تست واحد/یکپارچه با موفقیت پاس شدند.
...
مجموعه‌ی تست در `tests/` شامل fixtureهای قطعی و 12 تست است که **همگی پاس شدند**:
